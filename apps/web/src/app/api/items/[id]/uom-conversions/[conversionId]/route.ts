...
export async function PATCH(
  ...
  const cas = await casUpdate(prisma, 'uomConversion', conversionId, version, {...updates, updatedById: user!.id
});
  ...
  const updated = await prisma.uomConversion.findFirst({ where: { id: conversionId, deletedAt: null } });
