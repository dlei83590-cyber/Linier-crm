...
export async function PATCH(
  ...
  const cas = await casUpdate(prisma, 'dictionaryItem', itemId, version, {...updates, updatedById: user!.id
});
  ...
  const updated = await prisma.dictionaryItem.findFirst({ where: { id: itemId, deletedAt: null } });
