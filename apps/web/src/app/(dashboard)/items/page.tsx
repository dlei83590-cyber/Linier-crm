...
function ItemList() {
  ...
  const canCreate = can(state.user, actionPermission("item", "create"));
  const canEdit = can(state.user, actionPermission("item", "edit"));
  const canDelete = can(state.user, actionPermission("item", "delete"));
