...
function AdjustmentDetailPage() {
  ...
  const canEdit = can(state.user, actionPermission("inventory-adjustment", "edit"));
  const canApply = can(state.user, actionPermission("inventory-adjustment", "apply"));
  const canClose = can(state.user, actionPermission("inventory-adjustment", "close"));
