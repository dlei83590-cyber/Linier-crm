            ...
            {loading ? (
              ...
              items.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3 text-slate-600">{item.destinationWarehouse?.name ?? "—"}</td>
                  ...
                  <td className="px-4 py-3">
                    <Link href={`/inventory/transfers/${item.id}`} className="text-brand-600 hover:text-brand-700">
                      查看
                    </Link>
                  </td>
                </tr>
