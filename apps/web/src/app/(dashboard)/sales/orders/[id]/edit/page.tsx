      ...
      <div className="p-4">
        ...
        <div className="mb-4 grid grid-cols-2 gap-4 rounded-md bg-slate-50 p-4 text-sm md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-1 text-slate-700">{formatMoney(detail?.totalAmount ?? "0", detail?.currency ?? "CNY")}</p>
          </div>
          <div>
            <label className="block text-xs text-slate-500">要求交货日期（可选，清空即置空）</label>
            <input
              type="datetime-local"
          ...
          <div>
            <label className="block text-xs text-slate-500">付款条件（可选，≤50）</label>
            <input
              value={paymentTerm}
          ...
          <div>
            <label className="block text-xs text-slate-500">贸易术语（可选，≤50）</label>
            <input
              value={incoterm}
