    ...
    return (
      <div className={CARD_CLASS}>
        <div className="flex items-center justify-between border-b border-border p-4">
          <h1 className="text-lg font-semibold text-ink-primary">编辑质检记录</h1>
          <Link
      ...
      <div className="p-4">
        ...
        <div className="mb-4 rounded-md bg-canvas p-4 text-sm">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div>
              <p className="text-xs text-ink-secondary">来源收货行</p>
            ...
            <div>
              <p className="text-xs text-ink-secondary">物料</p>
            ...
            <div>
              <p className="text-xs text-ink-secondary">到货数量</p>
              <p className="mt-1 text-ink-secondary">
            ...
            <div>
              <p className="text-xs text-ink-secondary">现场拒收</p>
              <p className="mt-1 text-ink-secondary">{detail?.purchaseReceiptLine?.rejectedOnReceiptQty ?? "0"}</p>
            </div>
          </div>
        </div>
