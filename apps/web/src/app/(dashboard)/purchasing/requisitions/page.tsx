...
function RequisitionList() {
  ...
  const canCreate =
    ...
    state.user !== null &&
    can(state.user, actionPermission("purchase-requisition", "create"));
  const canEdit = can(state.user, actionPermission("purchase-requisition", "edit"));
  const canDelete = can(state.user, actionPermission("purchase-requisition", "delete"));
