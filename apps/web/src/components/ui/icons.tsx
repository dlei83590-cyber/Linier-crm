/**
 * Icons — Lucide 风格线性图标集（UI-03 Dashboard & Reports 共用）
 *
 * 产品图标统一线性 stroke（fill=none / stroke=currentColor），禁止 emoji 当产品图标。
 * 全部 24×24 viewBox，strokeWidth 1.75，继承父级 currentColor 与尺寸 class。
 */
