...
| Sprint 4 | Sales（销售） | 🔄 | 4A Quotation Foundation ✅（PR #12）；4B Sales Order Foundation ✅（PR #13）；4C Delivery 设计中 |
...
## 6. Sprint 4：Sales（销售）🔄（4A Quotation ✅，4B Sales Order ✅，4C Delivery 设计先行）
...
| Delivery | 发货单（DO，关联订单，触发库存出库） | ⬜ 4C 设计先行 |
