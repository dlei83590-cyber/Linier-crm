...
| M4.1   | **B2-2A / B2-2B（Project Financial/Progress Frontend）FINAL CLOSED** | Production `dcefea3e`（PR #75 含 RBAC drift 修复），**31/31 Runtime Acceptance PASS — ACCEPTED**（2026-08-17，QA 证据 docs/qa/B2-2_Runtime_QA.md；PR #70-#75 已合并）；Project Lifecycle（Acceptance/Transition/Close/Attachments）→ Contract Audit（HOLD，审计 FINAL 前不实现） |
