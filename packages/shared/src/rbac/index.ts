...
const ROLE_PERMISSIONS: Record<RoleCode, PermissionCode[]> = {
  ...
  MANAGER: [
    ...
    "warehouse-location:view", "warehouse-location:create", "warehouse-location:edit", "warehouse-location:delete", "warehouse-location:approve", "warehouse-location:audit", "warehouse-location:export", "warehouse-location:import", "warehouse-location:assign", "warehouse-location:close",
